...
class BottomNavBar extends StatefulWidget {
  const BottomNavBar({super.key, required void Function(dynamic i) onTap});
          ...
          BottomNavigationBarItem(
            icon: Container(
              ...
              child: Image.asset(
                ...
                width: 21,
                color: selectedIndex == 0 ? redColor : greyColor,
              ),
            ),
            label: 'Home',
          ),
          BottomNavigationBarItem(
            icon: Container(
              ...
              child: Image.asset(
                ...
                width: 24,
                color: selectedIndex == 1 ? redColor : greyColor,
              ),
            ),
            label: 'Poin',
          ),
          BottomNavigationBarItem(
            icon: Container(
              ...
              child: Image.asset(
                ...
                width: 25,
                color: selectedIndex == 2 ? redColor : greyColor,
              ),
            ),
            label: 'Shop',
          ),
          BottomNavigationBarItem(
            icon: Container(
              ...
              child: Image.asset(
                ...
                width: 27,
                color: selectedIndex == 3 ? redColor : greyColor,
              ),
            ),
            label: 'Explore',
          ),
          BottomNavigationBarItem(
            icon: Container(
              ...
              child: Image.asset(
                ...
                width: 20,
                color: selectedIndex == 4 ? redColor : greyColor,
              ),
            ),
            label: 'Menu',
          ),
